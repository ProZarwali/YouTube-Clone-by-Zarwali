...
import { formatPublishedAt } from "../../data";
      ...
      <div className="play-video-info">
        ...
        <div>
          <span>
            ...
            {apiData ? value_converter(apiData.statistics.likeCount) : "1k"}
          </span>
            ...
            <div key={index} className="comment">
              ...
              <div>
                <h3>
                  ...
                  <span>
                  {formatPublishedAt(item.snippet.topLevelComment.snippet.publishedAt)}
                  </span>
                </h3>
